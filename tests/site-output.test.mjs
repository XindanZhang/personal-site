...
test("build exports a terminal-native Next.js site structure", () => {
  ...
  try {
    ...
    assert.match(cssBundle, /#0d1117/i);
    assert.match(cssBundle, /#e6edf3/i);
    assert.match(cssBundle, /#58a6ff/i);
    assert.match(cssBundle, /#79c0ff/i);
    assert.match(cssBundle, /#a371f7/i);
    assert.match(cssBundle, /#f6f8fa/i);
    assert.match(cssBundle, /#218bff/i);
    assert.match(cssBundle, /--block-journal:#79c0ff/i);
    assert.match(cssBundle, /--block-projects:#f778ba/i);
    assert.match(cssBundle, /--block-readme:#a371f7/i);
    ...
    assert.doesNotMatch(cssBundle, /#071019/i);
    assert.doesNotMatch(cssBundle, /#eaf1ff/i);
    assert.doesNotMatch(cssBundle, /#63d5ff/i);
    assert.doesNotMatch(cssBundle, /#ffbe67/i);
    assert.doesNotMatch(cssBundle, /#8f7cff/i);
    assert.doesNotMatch(cssBundle, /#f4f7ff/i);
    assert.doesNotMatch(cssBundle, /#72b7ff/i);
