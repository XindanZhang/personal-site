...
test("build exports a terminal-native Next.js site structure", () => {
  ...
  try {
    ...
    assert.match(cssBundle, /#0b0f10/i);
    assert.match(cssBundle, /#e7e1cf/i);
    assert.match(cssBundle, /#89b482/i);
    assert.match(cssBundle, /#d8a657/i);
    assert.match(cssBundle, /#7daea3/i);
    assert.match(cssBundle, /#f3efe2/i);
    assert.match(cssBundle, /#7aa2c1/i);
    assert.match(cssBundle, /--block-journal:#7aa2c1/i);
    assert.match(cssBundle, /--block-projects:#d3869b/i);
    assert.match(cssBundle, /--block-readme:#a899d1/i);
