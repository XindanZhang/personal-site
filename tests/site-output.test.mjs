...
test("build exports a terminal-native Next.js site structure", () => {
  ...
  try {
    ...
    assert.match(cssBundle, /#071019/i);
    assert.match(cssBundle, /#eaf1ff/i);
    assert.match(cssBundle, /#63d5ff/i);
    assert.match(cssBundle, /#ffbe67/i);
    assert.match(cssBundle, /#8f7cff/i);
    assert.match(cssBundle, /#f4f7ff/i);
    assert.match(cssBundle, /#72b7ff/i);
    assert.match(cssBundle, /--block-journal:#72b7ff/i);
    assert.match(cssBundle, /--block-projects:#ff8ab3/i);
    assert.match(cssBundle, /--block-readme:#b291ff/i);
    ...
    assert.match(cssBundle, /--aurora-a:/i);
    assert.match(cssBundle, /--aurora-b:/i);
    assert.match(cssBundle, /--aurora-c:/i);
    ...
    assert.match(cssBundle, /@keyframes terminal-aurora/i);
    assert.match(cssBundle, /@keyframes terminal-chroma/i);
    ...
    assert.doesNotMatch(cssBundle, /#0b0f10/i);
    assert.doesNotMatch(cssBundle, /#e7e1cf/i);
    assert.doesNotMatch(cssBundle, /#89b482/i);
    assert.doesNotMatch(cssBundle, /#d8a657/i);
    assert.doesNotMatch(cssBundle, /#7daea3/i);
    assert.doesNotMatch(cssBundle, /#f3efe2/i);
    assert.doesNotMatch(cssBundle, /#7aa2c1/i);
