  ...
  return (
    <SiteLayout active="home">
      <div className="terminal-dashboard">
        <div className="terminal-pane is-hero">
        ...
        <div className="terminal-pane is-workspace">
        ...
        <div className="terminal-pane is-feed">
          <PromptSection
        ...
        {featuredProject || nextminiSeries ? (
          <div className="terminal-pane is-manifest">
            <PromptSection
        ...
        <div className="terminal-pane is-status">
