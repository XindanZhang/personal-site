...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function cc(e,t,n){let r=new Float32Array(Js),i=new W(0,1,0);return new $a({name:`SphericalGaussianBlur`,defines:{n:Js,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:dc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function lc(){return new $a({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:dc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function uc(){return new $a({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:dc(),fragmentShader:`
	...
	`}var fc=class extends Qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new aa(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
diffuseColor.rgb += cosmicCyan * cosmicWave * 0.16;`).replace(`#include <emissivemap_fragment>`,`#include <emissivemap_fragment>
totalEmissiveRadiance += vec3(0.08, 0.72, 1.0) * (cosmicWave * 0.13 + cosmicSpark * 1.8);`)},t.customProgramCacheKey=()=>`cosmic-armor-v1`,t}function Df(e){return{cosmic:Ef(e),suit:new to({color:461587,metalness:.45,roughness:.62}),shell:new no({color:1120547,metalness:.88,roughness:.24,clearcoat:.75,clearcoatRoughness:.18}),metal:new to({color:2108470,metalness:.9,roughness:.3}),cyan:new to({color:5105919,emissive:556954,emissiveIntensity:2.1,metalness:.35,roughness:.25}),cyanGlow:new Gr({color:6877183,transparent:!0,opacity:.88,toneMapped:!1}),violetGlow:new Gr({color:10190079,transparent:!0,opacity:.72,toneMapped:!1}),glass:new no({color:1586763,transparent:!0,opacity:.13,metalness:.1,roughness:.08,clearcoat:1,side:1,depthWrite:!1}),visor:new no({color:465187,emissive:698820,emissiveIntensity:1.45,metalness:.72,roughness:.08,clearcoat:1,transparent:!0,opacity:.94})}}function Of(e){let t=wf(),n=e?780:1450,r=new Float32Array(n*3),i=new Float32Array(n*3),a=new Y(8641023),o=new Y(16766883),s=new Y;for(let e=0;e<n;e+=1){let n=t()*Math.PI*2,c=t()*2-1,l=Math.sqrt(1-c*c),u=42+t()*34,d=e*3;r[d]=Math.cos(n)*l*u,r[d+1]=c*u+5,r[d+2]=Math.sin(n)*l*u-8,s.copy(a).lerp(o,t()*.38);let f=.55+t()*.45;i[d]=s.r*f,i[d+1]=s.g*f,i[d+2]=s.b*f}let c=new jr;c.setAttribute(`position`,new gr(r,3)),c.setAttribute(`color`,new gr(i,3));let l=new ra(c,new Qi({size:e?.12:.15,sizeAttenuation:!0,transparent:!0,opacity:.88,vertexColors:!0,depthWrite:!1,fog:!1}));return l.renderOrder=-5,l}function kf(e){let t=new ri(new Ha(8.2,64,40),new to({color:1319243,emissive:527140,emissiveIntensity:.85,metalness:.08,roughness:.78}));t.position.set(-18,10,-35),t.receiveShadow=!0,e.add(t);let n=new ri(new Ha(8.72,64,40),new $a({transparent:!0,depthWrite:!1,side:1,blending:2,vertexShader:`
varying vec3 vNormal;
varying vec3 vView;
void main() {
...
}`}));n.position.copy(t.position),e.add(n);let r=new ri(new Va(10.2,13.8,128),new Gr({color:7902919,transparent:!0,opacity:.16,side:2,depthWrite:!1}));return r.position.copy(t.position),r.rotation.set(1.18,.18,-.24),e.add(r),t}function Af(e,t){let n=new On;n.name=`Aerospace office`,e.add(n),$(n,new da(12.8,12.8,.28,72),t.shell,new W(1.2,-2.04,0)),$(n,new da(4.6,5.1,.22,64),t.metal,new W(2.5,-1.82,0));let r=new js(25,30,3004911,1389636),i=Array.isArray(r.material)?r.material:[r.material];for(let e of i)e.transparent=!0,e.opacity=.22;r.position.set(1.2,-1.87,0),n.add(r);for(let e of[4.9,8.1,12.4]){let r=t.cyanGlow.clone();r.opacity=e===4.9?.58:.24,$(n,new Ua(e,.035,6,128),r,new W(1.2,-1.84,0),new J(Math.PI/2,0,0))}let a=$(n,new da(17,17,10,72,1,!0,Math.PI*.14,Math.PI*1.72),t.glass,new W(1.2,3,0));a.castShadow=!1;for(let e=-5;e<=5;e+=1){let r=e*.205,i=1.2+Math.sin(r)*16.72,a=-Math.cos(r)*16.72;$(n,new da(.055,.055,10,8),t.metal,new W(i,3,a))}for(let e of[-1.65,3,7.65])$(n,new Ua(16.75,.07,7,160),t.metal,new W(1.2,e,0),new J(Math.PI/2,0,0));let o=new On;o.position.set(-2.7,-.65,-.15),o.rotation.y=-.18,n.add(o),$(o,new la(3.8,.18,1.25),t.shell,new W(0,0,0)),$(o,new la(.18,1.25,.85),t.metal,new W(-1.5,-.7,0)),$(o,new la(.18,1.25,.85),t.metal,new W(1.5,-.7,0)),$(o,new la(3.35,.035,.08),t.cyanGlow,new W(0,.13,.58));let s=new On;s.position.set(-2.7,.28,-.35),s.rotation.y=-.18,n.add(s);let c=new Gr({color:5039871,transparent:!0,opacity:.14,side:2,depthWrite:!1});for(let e=0;e<3;e+=1){let t=$(s,new Ba(.9,.58),c,new W((e-1)*1.03,e===1?.18:0,0),new J(-.08,0,0));t.castShadow=!1}return $(n,new Ua(4.25,.09,8,96),t.violetGlow,new W(2.5,6.4,-.6),new J(Math.PI/2,0,0)),s}function jf(e){let t=new On;t.name=`Aerospace executive chair`,$(t,new da(.72,.95,.2,48),e.shell,new W(0,-1.72,-.05)),$(t,new da(.26,.36,1.05,32),e.metal,new W(0,-1.18,-.05)),$(t,new Ua(.98,.075,8,64),e.cyan,new W(0,-1.64,-.05),new J(Math.PI/2,0,0)),$(t,new la(2.05,.34,1.8),e.shell,new W(0,-.48,.12),new J(-.05,0,0)),$(t,new ua(.82,1.75,10,20),e.shell,new W(0,.62,-.62),new J(-.22,0,0),new W(1.02,1,.29)),$(t,new ua(.52,.34,8,18),e.metal,new W(0,1.82,-.93),new J(-.18,0,0),new W(1.2,1,.36));for(let n of[-1,1])$(t,new la(.18,.22,1.35),e.metal,new W(n*1.04,.05,.18),new J(0,0,n*-.04)),$(t,new la(.08,.04,1.1),e.cyanGlow,new W(n*1.04,.18,.18)),$(t,new Wa(new Sa([new W(n*.92,-1.58,-.1),new W(n*1.22,-.55,-.22),new W(n*1.17,.65,-.62),new W(n*.68,1.78,-.95)]),48,.065,8,!1),e.metal,new W);return $(t,new la(1.25,.035,.07),e.cyanGlow,new W(0,1.76,-.74),new J(-.2,0,0)),t}function Mf(e){let t=new On;t.name=`Three-tube shoulder launcher`,t.position.set(.79,1.54,-.42),t.rotation.set(-.08,-.06,-.12),$(t,new la(.5,.38,.9),e.shell,new W(0,0,0)),$(t,new la(.62,.08,.72),e.cosmic,new W(0,.21,-.02));for(let n of[-.16,0,.16])$(t,new da(.065,.09,.78,12),e.metal,new W(n,0,.08),new J(Math.PI/2,0,0)),$(t,new Ua(.075,.018,6,18),e.cyanGlow,new W(n,0,.48));return t}function Nf(e){let t=new On;t.name=`Procedural armored operator`,$(t,new Ha(.48,24,16),e.suit,new W(0,-.04,-.02),new J,new W(1.08,.78,.9)),$(t,new ua(.48,.82,8,18),e.suit,new W(0,.83,-.3),new J(-.28,0,0),new W(1,1,.78)),$(t,new la(1.12,.74,.38),e.cosmic,new W(0,1.1,-.19),new J(-.28,0,0));for(let n=0;n<3;n+=1)$(t,new la(.78-n*.08,.16,.3),e.cosmic,new W(0,.62-n*.2,-.02+n*.03),new J(-.2,0,0));let n=$(t,new Ha(.44,30,22),e.cosmic,new W(0,1.92,-.51),new J(-.12,0,0),new W(.9,1.08,1));n.castShadow=!0,$(t,new la(.62,.22,.08),e.visor,new W(0,1.98,-.08),new J(-.08,0,0)),$(t,new la(.52,.24,.16),e.cosmic,new W(0,1.72,-.12),new J(-.16,0,0)),$(t,new fa(.08,.58,5),e.cyan,new W(0,2.42,-.61),new J(.2,0,0)),t.add(Mf(e));let r=new W(-.66,1.25,-.28),i=new W(.66,1.25,-.28),a=new W(-.92,.48,-.02),o=new W(.92,.48,-.02),s=new W(-.91,.03,.48),c=new W(.91,.03,.48);Tf(t,r,a,.21,e.suit),Tf(t,i,o,.21,e.suit),Tf(t,a,s,.18,e.suit),Tf(t,o,c,.18,e.suit),$(t,new Ha(.31,18,12),e.cosmic,r,new J,new W(1.2,.72,1)),$(t,new Ha(.31,18,12),e.cosmic,i,new J,new W(1.2,.72,1)),$(t,new la(.32,.5,.28),e.cosmic,a.clone().lerp(s,.38)),$(t,new la(.32,.5,.28),e.cosmic,o.clone().lerp(c,.38)),$(t,new Ha(.2,16,10),e.suit,s),$(t,new Ha(.2,16,10),e.suit,c);let l=new W(-.34,-.1,.08),u=new W(.34,-.1,.08),d=new W(-.52,-.67,1.02),f=new W(.52,-.67,1.02),p=new W(-.54,-1.57,1.35),m=new W(.54,-1.57,1.35);return Tf(t,l,d,.29,e.suit),Tf(t,u,f,.29,e.suit),Tf(t,d,p,.24,e.suit),Tf(t,f,m,.24,e.suit),Tf(t,l.clone().lerp(d,.06),d.clone().lerp(l,.2),.32,e.cosmic),Tf(t,u.clone().lerp(f,.06),f.clone().lerp(u,.2),.32,e.cosmic),$(t,new Ha(.3,18,12),e.cosmic,d,new J,new W(1,.82,1)),$(t,new Ha(.3,18,12),e.cosmic,f,new J,new W(1,.82,1)),$(t,new la(.46,.56,.34),e.cosmic,d.clone().lerp(p,.54)),$(t,new la(.46,.56,.34),e.cosmic,f.clone().lerp(m,.54)),$(t,new la(.48,.3,.75),e.shell,p.clone().add(new W(0,-.05,.25)),new J(-.12,0,0)),$(t,new la(.48,.3,.75),e.shell,m.clone().add(new W(0,-.05,.25)),new J(-.12,0,0)),t}function Pf(e){let t=t=>{let n=e.getObjectByName(t);return n instanceof gi?n:void 0},n=[],r=(e,r,i,a)=>{let o=t(e),s=r?t(r):void 0;o&&(!r||s)&&n.push({bone:o,child:s,axis:i,direction:a.normalize()})};r(`Hips`,`Abdomen`,Cf,new W(0,.94,-.34)),r(`Abdomen`,`Torso`,Cf,new W(0,.95,-.31)),r(`Torso`,`Chest`,Cf,new W(0,.96,-.27)),r(`Chest`,`Neck`,Cf,new W(0,.99,-.12)),r(`Neck`,`Head`,Cf,new W(0,.99,.06)),r(`ShoulderL`,`UpperArmL`,Cf,new W(.62,-.36,.32)),r(`UpperArmL`,`LowerArmL`,Cf,new W(.22,-.82,.53)),r(`LowerArmL`,`WristL`,Cf,new W(-.04,-.45,.89)),r(`ShoulderR`,`UpperArmR`,Cf,new W(-.62,-.36,.32)),r(`UpperArmR`,`LowerArmR`,Cf,new W(-.22,-.82,.53)),r(`LowerArmR`,`WristR`,Cf,new W(.04,-.45,.89)),r(`UpperLegL`,`LowerLegL`,Cf,new W(.12,-.36,.93)),r(`LowerLegL`,void 0,Cf,new W(0,-.97,.24)),r(`UpperLegR`,`LowerLegR`,Cf,new W(-.12,-.36,.93)),r(`LowerLegR`,void 0,Cf,new W(0,-.97,.24));let i=t(`Hips`),a=t(`FootL`),o=t(`FootR`),s=new Nt,c=new W,l=new Nt,u=new Nt,d=new Nt,f=new Nt,p=new W,m=new W,h=new W,g=new W,_=new W,v=new W,y=new W,b=new W(.22,-.58,.55),x=new W(-.22,-.58,.55),S=(t,n)=>{!t?.parent||!i||(e.updateMatrixWorld(!0),i.getWorldPosition(_),y.copy(n).multiply(c).applyQuaternion(s),v.copy(_).add(y),t.position.copy(t.parent.worldToLocal(v)))};return()=>{e.updateMatrixWorld(!0),e.getWorldQuaternion(s),e.getWorldScale(c);for(let t of n)e.updateMatrixWorld(!0),t.bone.getWorldQuaternion(l),t.child?(t.bone.getWorldPosition(p),t.child.getWorldPosition(m),h.copy(m).sub(p).normalize()):h.copy(t.axis).applyQuaternion(l).normalize(),g.copy(t.direction).applyQuaternion(s).normalize(),f.setFromUnitVectors(h,g),d.copy(f).multiply(l),t.bone.parent?.getWorldQuaternion(u),t.bone.quaternion.copy(u.invert().multiply(d));e.updateMatrixWorld(!0),e.getWorldQuaternion(s),e.getWorldScale(c),S(a,b),S(o,x),e.updateMatrixWorld(!0)}}function Ff(e){let t=new Set;for(let n of e){for(let e of Object.values(n))e instanceof Yt&&t.add(e);n.dispose()}t.forEach(e=>e.dispose())}async function If(e,t){try{let n=await new Cd().loadAsync(e),r=new On;r.name=`Rigged cosmic operator`;let i=n.scene;i.name=`Quaternius spacesuit`,i.scale.setScalar(2.18),r.add(i);let a=new Set;i.traverse(e=>{if(!(e instanceof ri))return;let n=Array.isArray(e.material)?e.material:[e.material];n.forEach(e=>a.add(e));let r=e=>/Light_Accent/i.test(e.name)?t.cyan:/SciFi_Light/i.test(e.name)?t.cosmic:/MainDark/i.test(e.name)?t.suit:/Grey/i.test(e.name)?t.metal:t.shell;e.material=Array.isArray(e.material)?n.map(r):r(n[0]),e.castShadow=!0,e.receiveShadow=!0,e.frustumCulled=!1}),Ff(a);let o=new Ts(i),s=n.animations.find(e=>e.name===`Idle_Neutral`)??n.animations.find(e=>e.name===`Idle`);if(s){let e=o.clipAction(s);e.setLoop(Pe,1/0),e.timeScale=.28,e.play(),o.setTime(s.duration*.45)}let c=Pf(i),l=i.getObjectByName(`Hips`),u=new W(0,-.08,-.04),d=new W,f=new W,p=new W,m=new Nt,h=new W,g=()=>{!l||!i.parent||(r.updateMatrixWorld(!0),i.updateMatrixWorld(!0),l.getWorldPosition(d),f.copy(u),r.localToWorld(f),p.copy(f).sub(d),i.parent.getWorldQuaternion(m),i.parent.getWorldScale(h),p.applyQuaternion(m.invert()).divide(h),i.position.add(p),i.updateMatrixWorld(!0))};return g(),c(),g(),r.add(Mf(t)),{group:r,update(e){s&&o.update(e),g(),c()},dispose(){o.stopAllAction(),o.uncacheRoot(i)}}}catch{return null}}async function Lf(e){let{container:n,modelUrl:r=`/personal-site/models/cosmic-operator.glb`,reducedMotion:i,onReady:a,onFallback:o}=e,s=n.clientWidth<700,c=!1,l=!1,u=!1,d=0,f=0,p=0,m=-1,h=i,g=s,_=!1,v=new Xu({antialias:!0,alpha:!1,powerPreference:`high-performance`});v.setClearColor(132106,1),v.outputColorSpace=Ue,v.toneMapping=4,v.toneMappingExposure=1.04,v.shadowMap.enabled=!s,v.shadowMap.type=1,v.domElement.setAttribute(`aria-hidden`,`true`),v.domElement.tabIndex=-1,n.appendChild(v.domElement);let y=new Ln;y.background=new Y(132106),y.fog=new In(198416,.013);let b=new Yo(s?41:36,1,.1,160);b.position.set(s?7.2:9.2,s?3.1:4.15,s?11.8:13.4);let x=new sd(b,n);x.target.set(1.15,.15,0),x.enableDamping=!h,x.dampingFactor=.065,x.enablePan=!1,x.enableZoom=!h,x.enableRotate=!h,x.rotateSpeed=.48,x.zoomSpeed=.82,x.minDistance=s?6.8:7.6,x.maxDistance=s?15.4:16.2,x.minPolarAngle=.44,x.maxPolarAngle=1.5,x.touches.TWO=t.DOLLY_ROTATE,x.update(),x.saveState();let S={value:0},C=Df(S),w=Of(s);y.add(w);let T=kf(y),E=Af(y,C),D=new On;D.position.set(2.45,0,-.05),y.add(D),D.add(jf(C));let O=await If(r,C)??{group:Nf(C),update:()=>void 0,dispose:()=>void 0},k=O.group;k.position.z+=.02,D.add(k);let A=k.rotation.y,ee=new Gr({color:6680575,transparent:!0,opacity:0,side:2,depthWrite:!1,blending:2}),j=new ri(new Va(.3,.34,72),ee);j.rotation.x=-Math.PI/2,j.position.y=-1.8,j.visible=!1,y.add(j);let M=new Lo(9362687,329485,1.15);y.add(M);let te=new ns(14284287,3.4);te.position.set(-6,9,8),te.castShadow=!s,te.shadow.mapSize.set(1024,1024),te.shadow.camera.near=1,te.shadow.camera.far=32,te.shadow.camera.left=-9,te.shadow.camera.right=9,te.shadow.camera.top=9,te.shadow.camera.bottom=-9,y.add(te);let N=new Zo(5106175,55,22,Math.PI*.24,.55,1.4);N.position.set(7,5,-6),N.target.position.set(2.4,.4,0),y.add(N,N.target);let P=new $o(7757055,18,15,1.5);P.position.set(-3,2,-4),y.add(P);let ne=new U,re=new U,ie=new Ds,ae=new Ni(new W(0,1,0),1.8),oe=new W(1.2,-1.8,0),se=new W;function ce(){if(c)return;let e=Math.max(1,n.clientWidth),t=Math.max(1,n.clientHeight),r=e<700;r!==g&&(g=r,b.position.set(r?7.2:9.2,r?3.1:4.15,r?11.8:13.4),x.target.set(1.15,.15,0),x.minDistance=r?6.8:7.6,x.maxDistance=r?15.4:16.2,x.update(),x.saveState()),v.shadowMap.enabled=!r,te.castShadow=!r,b.aspect=e/t,b.fov=r?41:36,b.updateProjectionMatrix(),v.setPixelRatio(Math.min(window.devicePixelRatio||1,r?1.2:1.5)),v.setSize(e,t,!1),x.update(),v.render(y,b)}function F(e){if(m<0)return;m+=e;let t=Math.min(1,m/.85);j.visible=t<1,j.scale.setScalar(.5+t*5.4),ee.opacity=(1-t)*.72,t>=1&&(m=-1)}function le(e){if(!l||c)return;let t=p===0?0:Math.min((e-p)/1e3,.05);p=e,f+=t,S.value=f;let n=1-Math.exp(-t*5.8);re.lerp(ne,n),w.rotation.y+=t*.0025,T.rotation.y+=t*.018,E.position.y=.28+Math.sin(f*.9)*.025,E.rotation.z=re.x*.008,k.rotation.y=A+re.x*.018+Math.sin(f*.45)*.006,O.update(t),N.position.x=7+re.x*.8,N.position.y=5+re.y*.45,F(t),x.update(t),v.render(y,b),d=window.requestAnimationFrame(le)}function ue(){c||l||h||(l=!0,p=0,d=window.requestAnimationFrame(le))}function de(){l=!1,window.cancelAnimationFrame(d),p=0}function fe(){u=!0,ue()}function pe(){u=!1,de()}function me(e,t){h||ne.set(Mt.clamp(e,-1,1),Mt.clamp(t,-1,1))}function he(e,t){if(h)return;ie.setFromCamera(new U(e,t),b);let n=ie.ray.intersectPlane(ae,new W);n&&(se.copy(n).sub(oe).setY(0),se.lengthSq()>11.5*11.5&&n.copy(oe).add(se.setLength(11.5)),j.position.set(n.x,-1.8,n.z),j.scale.setScalar(.5),j.visible=!0,m=0)}function ge(){h||(x.reset(),ne.set(0,0),re.set(0,0))}function _e(e){c||h===e||(h=e,x.enableDamping=!e,x.enableZoom=!e,x.enableRotate=!e,e?(de(),x.update(),v.render(y,b)):u&&ue())}function ve(e){e.preventDefault(),de(),n.classList.remove(`is-ready`),o()}async function ye(){if(!c)try{if(await v.compileAsync(y,b),c)return;ce(),a(),u&&ue()}catch{o()}}function be(){if(_)return;_=!0,c=!0,pe(),n.removeEventListener(`dblclick`,ge),v.domElement.removeEventListener(`webglcontextlost`,ve),v.domElement.removeEventListener(`webglcontextrestored`,ye),x.dispose(),O.dispose(),te.shadow.map?.dispose(),te.shadow.mapPass?.dispose();let e=new Set,t=new Set,r=new Set;y.traverse(n=>{n instanceof hi&&r.add(n.skeleton),(n instanceof ri||n instanceof ra||n instanceof Ki||n instanceof Xi)&&(e.add(n.geometry),(Array.isArray(n.material)?n.material:[n.material]).forEach(e=>t.add(e)))}),r.forEach(e=>e.dispose()),e.forEach(e=>e.dispose()),Ff(t),v.dispose(),v.domElement.remove()}n.addEventListener(`dblclick`,ge),v.domElement.addEventListener(`webglcontextlost`,ve),v.domElement.addEventListener(`webglcontextrestored`,ye);try{if(await v.compileAsync(y,b),c)throw Error(`Game scene disposed during initialization`);ce(),a()}catch(e){try{o()}finally{be()}throw e}return{resize:ce,setPointer:me,pulse:he,setReducedMotion:_e,start:fe,stop:pe,dispose:be}}export{Lf as createGameScene};